        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [               
                Text('أهلاً بك', style: Styles.textStyle14.copyWith(color:Color(0xffA6A6A6))),
                 CircleAvatar(radius: 24.r, backgroundImage: AssetImage('assets/profile.jpg')),
              ],
            ),
          ),
          Center(child: customDivider()),
          SizedBox(height: 15.h),
          Text('معلوماتك',style: Styles.textStyle13,),
          Padding(
            padding:  EdgeInsets.only(right:14.w),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.start,
              children: [
                Icon(WeatherIcons.day_cloudy,color: Color(0xff5C5D0E),),
                Text('الطقس',style: Styles.textStyle14.copyWith(color:Color(0xff5C5D0E)),)
              ],
            ),
          ),
          SizedBox(height: 15.h),
          Card(
            ...
            shape: RoundedRectangleBorder(side: BorderSide(color: Color(0xffE8E8E8)),borderRadius: BorderRadius.circular(10.r),),
            child: ListTile(
              title: Row(
                children: [
            ...
            child: Row(
              ...
              children: [
                Icon(Icons.grass, color: Color(0xff40AC44)),
                 Text('محاصيلك', style: Styles.textStyle14.copyWith(color:Color(0xff0E4E11))),
